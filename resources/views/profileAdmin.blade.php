...
<html lang="en">
    <head>
        ...
        <title>Shoppers - My Admin Profile</title>
    ...
    <body class="text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <div class="inner">
                <h3 class="masthead-brand">Administrator Profile</h3>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Phone : {{Auth::User()->phone}}</h5>
                        </div>
                        <div class="card-body">
                            <a class="text-secondary text-decoration-none" href="{{ route('logoutadmin') }}" class="text-white">logout</a>
                        </div>
                    </div>
                </div>
            </div>
